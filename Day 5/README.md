...
Linear Regression was selected because the target variable is continuous and numerical.
...
Measures how well the model explains the variation in energy consumption.
